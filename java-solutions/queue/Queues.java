...
public final class Queues {
    ...
    /* package-private */ static final Splitter<FunctionsModel> FUNCTIONS = (tester, queue, random) -> {
    ...
    /* package-private */ static final LinearTester<IfModel> IF = (tester, queue, random) -> {
        if (random.nextBoolean()) {
    ...
    /* package-private */ static final LinearTester<WhileModel> WHILE = (tester, queue, random) -> {
        if (random.nextBoolean()) {
    ...
    /* package-private */ static final LinearTester<IfWhileModel> IF_WHILE = (tester, queue, random) -> {
        final LinearTester<IfWhileModel> t = random.nextBoolean() ? IF::test : WHILE::test;
